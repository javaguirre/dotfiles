...
** Utilities
*** Powerline
    Activates powerline and sets a custom powerline theme

    #+begin_src emacs-lisp
      ;; (load-file "~/.emacs.d/my-powerline.el")

      ;; (require 'powerline)
      ;; (require 'powerline-evil)
      ;; (require 'my-powerline)

      ;; (set-face-attribute 'powerline-evil-normal-face nil :foreground "#EEAD0E")

      ;; (powerline-evil-my-theme)
    #+end_src
*** Nyan
    #+begin_src emacs-lisp
        (nyan-mode t)
